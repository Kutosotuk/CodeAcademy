...
function preload() {
    ...
    // rightParen = loadImage('https://content.codecademy.com/programs/code-foundations-path/bop-ii/par_right.png');
    // leftParen = loadImage('https://content.codecademy.com/programs/code-foundations-path/bop-ii/par_left.png');
    // comma = loadImage('https://content.codecademy.com/programs/code-foundations-path/bop-ii/comma.png');
}
...
function setup() {
    ...
    if (output.msg) {
        ...
        errorButton = new Button(width/2 - 15*wUnit, 6 * hUnit, 30 * wUnit, 6 * hUnit, output.msg, 'rect',
