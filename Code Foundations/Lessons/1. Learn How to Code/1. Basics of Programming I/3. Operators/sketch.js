...
function preload(){
    appleImg = loadImage('https://content.codecademy.com/programs/code-foundations-path/bop-i/operators/apple_new.png');
    orangeImg = loadImage('https://content.codecademy.com/programs/code-foundations-path/bop-i/operators/orange.png');
    checkmark = loadImage('https://content.codecademy.com/programs/code-foundations-path/bop-i/operators/checkmark.png');
