...
function preload(){
    bg = loadImage('https://content.codecademy.com/programs/code-foundations-path/bop-i/data-types/Computer.png')
}
...
function checkInputs(){
    ...
    if (programChoice == 'square'){
        try {
            ...
            textSize(10);
            fill('red');
            text('ERROR:', x-(xDistance*3), y-(yDistance));
            output = text("Input is " + err, x-(xDistance*3), y, 80, 80);
        }
        ...
        try {
            if(myString === "") throw "\nempty"
            if(typeof myString === "undefined") throw "\nundefined"
        ...
        try {
            ...
            if(typeof myBool.valueOf() != "boolean") throw "\nnot a boolean"
